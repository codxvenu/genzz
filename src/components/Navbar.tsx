...
export default function Navbar({ onOpenBooking }: NavbarProps) {
  ...
  const navLinks = [
    ...
    { label: 'THE PATH', target: 'path-to-growth-section' },
    { label: 'DIVISIONS', target: 'scene-sticky-storytelling' },
    { label: 'SYSTEMS', target: 'scene-transformation' },
    { label: 'METRICS', target: 'scene-impact' },
    { label: 'ATTENTION', target: 'scene-genz-edge' },
    { label: 'MODELER', target: 'calculator-section' }
  ];
