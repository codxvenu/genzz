...
export default function Calculator({ onOpenBooking }: CalculatorProps) {
  ...
  const needsList = [
    { title: 'Branding & Storytelling', index: '[α-1]' },
    { title: 'Social Media Marketing', index: '[μ-2]' },
    { title: 'Talent Placement / Recruitment', index: '[θ-3]' },
    { title: 'Lead Generation', index: '[λ-4]' },
    { title: 'Organizational Consulting', index: '[τ-5]' },
    { title: 'Location footprints', index: '[Ω-6]' }
  ];
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="space-y-4 mb-24 text-center max-w-3xl mx-auto flex flex-col items-center">
          ...
          <p className="font-sans text-xs sm:text-sm text-zinc-400 font-light tracking-wide max-w-md mx-auto leading-relaxed">
            Configure your ARR target index and check active pillars. Observe GBA&apos;s operational blueprint adjust dynamically.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch border-t border-b border-white/10 py-12">
          ...
          <div className="lg:col-span-7 space-y-12 pr-0 lg:pr-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-[10px] font-mono tracking-[0.3em] text-[#A1A1AA] uppercase font-bold">REVENUE TARGET CONSTANT</span>
                </div>
              ...
              <div className="relative pt-2">
                ...
                <div className="flex items-center justify-between text-[8px] font-mono text-zinc-500 font-bold pt-4 uppercase tracking-widest">
                  ...
                  <span>$8M (Expansion)</span>
                  <span>$15M (Enterprise)</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6 pt-8 border-t border-white/5">
              <span className="text-[10px] font-mono tracking-[0.3em] text-[#A1A1AA] uppercase block font-bold">ACTIVE PARAMETER VECTORS</span>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <span className="font-mono text-[8px] text-zinc-550 mr-1">{need.index}</span>
                      ...
                      <div className={`w-3.5 h-3.5 rounded-full border flex items-center justify-center transition-all ${
                        ...
                        {isChecked && <span className="text-[7px] font-mono font-bold">L</span>}
                      </div>
                    </button>
                  );
                })}
          ...
          <div className="lg:col-span-5 lg:border-l lg:border-white/10 lg:pl-12 flex flex-col justify-between space-y-12">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center justify-between border-b border-white/5 pb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#A1A1AA] font-bold">BLUEPRINT ESTIMATOR SPEC</span>
                </div>
                <span className="font-mono text-[8px] text-zinc-650 font-extrabold uppercase">COHERENT REGISTRY</span>
              </div>
              ...
              <div className="space-y-8 py-4">
                ...
                <div className="flex justify-between items-baseline border-b border-dashed border-white/5 pb-4">
                  <div className="space-y-0.5">
                    <span className="text-[9px] font-mono uppercase tracking-widest text-[#71717a] font-bold block">DURATION COEF</span>
                    <span className="text-xs text-zinc-400 font-light font-sans">Full Operational Sync Time</span>
                  </div>
                  <span className="font-serif text-3xl text-white font-normal">{calcs.timelineWeeks} Weeks</span>
                </div>

                {/* Metrics 2 */}
                <div className="flex justify-between items-baseline border-b border-dashed border-white/5 pb-4">
                  <div className="space-y-0.5">
                    <span className="text-[9px] font-mono uppercase tracking-widest text-[#71717a] font-bold block">OPERATORS PLACEMENTS</span>
                    <span className="text-xs text-zinc-400 font-light font-sans">Dedicated Core Talent</span>
                  </div>
                  <span className="font-serif text-3xl text-white font-normal">{calcs.suggestedHeadcount} Headcount</span>
                </div>

                {/* Metrics 3 */}
                <div className="flex justify-between items-baseline pb-2">
                  <div className="space-y-0.5">
                    <span className="text-[9px] font-mono uppercase tracking-widest text-purple-400 font-bold block">PROJECTED MULTIPLIER</span>
                    <span className="text-xs text-zinc-400 font-light font-sans">Leverage Growth Quotient</span>
                  </div>
                  <span className="font-serif text-4xl text-[#C084FC] font-semibold">{calcs.estimatedRoi}x ROI</span>
                </div>
            ...
            <div className="space-y-4 pt-6 border-t border-white/10">
              <button
                ...
                className="w-full py-4 bg-[#7C3AED] hover:bg-[#6D28D9] text-white text-[11px] font-mono tracking-widest uppercase rounded-full transition-all duration-300 shadow-md shadow-purple-900/40 flex items-center justify-center space-x-2 cursor-pointer"
              >
                <span>Request Custom Specifications</span>
                <ArrowRight className="w-3.5 h-3.5" />
              </button>
              <div className="flex justify-between font-mono text-[7px] text-zinc-550 uppercase tracking-wider">
                <span>SIM_ALGO_GBA_V1</span>
                <span>All calculations are systemic estimates</span>
              </div>
            </div>
