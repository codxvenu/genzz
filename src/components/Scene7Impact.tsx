  ...
  const evidenceRecords = [
    {
      id: '01',
      metric: '8.3x ROI',
      subMetric: 'EBITDA Expansion',
      partner: 'Mercer Logistics Group',
      niche: 'Global supply chain enterprise',
      case: 'Complete workflow transmutation. Retained GBA core operators, built automated dispatch sync engines, and captured high-frequency digital leads.',
      deliverables: ['Custom Operations System', 'Social Narrative Capture', 'Inbound Flow Turbines'],
      duration: '12 Months'
    },
    {
      id: '02',
      metric: '+340%',
      subMetric: 'Organic Inbound Volume',
      partner: 'Zenith FinTech Systems',
      niche: 'Niche asset placement platform',
      case: 'Overturned standard visual designs for native video storytelling. Programmed algorithm hooks driving decentralized viral syndicates, yielding qualified applications without paid ads.',
      deliverables: ['Algorithm Decoding Web', 'Native Creator Placements', 'Brand Identity Specs'],
      duration: '6 Months'
    },
    {
      id: '03',
      metric: '2.4M',
      subMetric: 'Attention Arbitrage Leads',
      partner: 'Vapor Retail Co.',
      niche: 'Direct lifestyle consumer brand',
      case: 'Eradicated traditional un-aligned agency contractors. Deployed direct community nests inside forum nodes, capturing targeted client interest at half of historic acquisition costs.',
      deliverables: ['Regional Focus Maps', 'CRM Synced Workflows', 'Auditing Consulting Sheets'],
      duration: '8 Months'
    }
  ];
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-24 flex flex-col items-center">
          ...
          <div className="w-16 h-[1px] bg-zinc-855 my-4" />
          <p className="font-sans text-xs sm:text-sm text-zinc-400 font-light tracking-wide max-w-md mx-auto leading-relaxed">
            Real performance parameters verified natively. Compounding results established by unified operational setups.
          </p>
        </div>
            ...
            <div className="flex space-x-6 border-b border-white/5 pb-4">
              {evidenceRecords.map((story, i) => {
                ...
                return (
                  ...
                  >
                    <span className="font-mono text-[8px] text-zinc-650 tracking-widest font-extrabold group-hover:text-purple-400 transition-colors">
                      CASE_0{story.id}
                    </span>
                    <span className={`font-serif text-lg tracking-tight transition-all ${
                      isActive ? 'text-white font-normal' : 'text-zinc-500 group-hover:text-zinc-350'
                    }`}>
                      {story.partner}
                    </span>
                    {isActive && (
                      <motion.div 
                        ...
                        className="absolute bottom-[-1px] left-0 right-0 h-[1.5px] bg-purple-500"
                ...
                >
                  <div className="space-y-2">
                    <span className="font-mono text-[9px] uppercase tracking-widest text-[#7C3AED] font-bold block">
                      PARTNER DIRECTORY NICHING // {activeRecord.niche}
                    </span>
                  ...
                  <div className="space-y-2">
                    <span className="font-mono text-[8px] uppercase tracking-[0.25em] text-[#A1A1AA] font-bold block">
                      OPERATIONAL Blueprints IMPLEMENTED:
                    </span>
                    <div className="flex flex-wrap gap-2 pt-1">
                      {activeRecord.deliverables.map((item, id) => (
                        <span 
                          key={id} 
                          className="font-mono text-[9px] uppercase tracking-wider text-zinc-400 bg-white/5 border border-white/5 px-2.5 py-1 rounded"
                        >
                          {item}
                        </span>
                      ))}
          ...
          <div className="lg:col-span-5 lg:border-l lg:border-white/10 lg:pl-16 space-y-10 flex flex-col justify-center">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 font-mono text-[9px] uppercase tracking-wider text-zinc-450">
                  <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    <span className="text-[#71717A] text-[8px] font-extrabold font-mono block">SYSTEM STATUS</span>
